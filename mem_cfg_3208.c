...
//const uint32 g_file_system_data_block_num = 20;
const uint32 g_file_system_data_block_num = 256;

// The max file number that support.
//const uint32 g_file_system_file_num       = 8;
const uint32 g_file_system_file_num       = 16;
...
#else
	#define BYTE_HEAP_SIZE          (200 * 1024)  // 120K
#endif
...
#define MAX_NUM_OF_52_POOLS     800//250
...
#define MAX_NUM_OF_100_POOLS    400//60//80
...
#define MAX_NUM_OF_300_POOLS    300//40
...
#endif
#define MAX_NUM_OF_600_POOLS    40//25
...
#endif
#define MAX_NUM_OF_1600_POOLS   20//10
...
const uint32 const_StackLimitOffset  = 0xFDBFC;

const uint32 const_RAM_LimitOffset   = 0xFC000;
